export const cards = [
  ['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions', 'Fruit', 'Berries'],
  ['#/action-a', '#/action-b', '#/animal-a', '#/animal-b', '#/clothes', '#/emotions', '#/fruit', '#/berries'],
  [
    {
      word: 'cry',
      translation: 'плакать',
